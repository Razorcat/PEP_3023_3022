...
namespace eProdaja_Service.Data
{
    ...
    public partial class eProdajaEntities : DbContext
    {
        ...
        public virtual DbSet<Brosure> Brosure { get; set; }
        public virtual DbSet<BrosureProizvodi> BrosureProizvodi { get; set; }
        ...
        public virtual ObjectResult<esp_BrosureProizvodi_SelectAll_Result> esp_BrosureProizvodi_SelectAll()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<esp_BrosureProizvodi_SelectAll_Result>("esp_BrosureProizvodi_SelectAll");
        }
    
        public virtual int esp_Dobavljaci_Insert(string naziv, string kontaktOsoba, string adresa, string telefon, string fax, string web, string email, string ziroRacun, string napomena, Nullable<bool> status)
        {
            var nazivParameter = naziv != null ?
                new ObjectParameter("Naziv", naziv) :
                new ObjectParameter("Naziv", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("esp_Dobavljaci_Insert", nazivParameter, kontaktOsobaParameter, adresaParameter, telefonParameter, faxParameter, webParameter, emailParameter, ziroRacunParameter, napomenaParameter, statusParameter);
        }
